...
//Remove spaces, hyphens, letters and brackets
	...
	if (empty($errors)) {
		...
		if (mysqli_num_rows($result) == 0) {
			...
			$q = "UPDATE lmnmigrate SET title='$title', fname='$fn', lname='$ln', email='$e',
...
// Select the member's information
$q = "SELECT title, fname, lname, email, addr1, addr2, city, county, pcode, phone
FROM lmnmigrate WHERE user_id=$id";
$result = @mysqli_query($dbcon, $q);
if (mysqli_num_rows($result) == 1) {
	// If the user id is valid, display the form
