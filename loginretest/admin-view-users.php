...
<?php
/** This script retrieves all the records from the loginretest table. */
require 'mysqli-connect.php'; // Connect to the database.

/** Make the query: */
$t = "SELECT CONCAT(lname, ', ', fname) AS name, DATE_FORMAT(registration_date, '%M %d, %Y') AS regdat FROM loginretest ORDER BY registration_date ASC";
$result = @mysqli_query($dbcon, $t); // Run the query.
