...
$errors[] = 'You did not enter your first name.';
    ...
    else { //$uname = mysqli_real_escape_string($dbcon, trim($_POST['email']));
...
<form action="register-page.php" method="post">
  <div class="row"><!--Beginning of First Row-->
    <div class="large-4 medium-4 small-12 columns">
      <label>Title
        <input id="title" type="text" name="title" size="30" maxlength="30" placeholder="Title" value="<?php if (isset($_POST['title'])) echo $_POST['title']; ?>" />
      </label>
    </div>
  	<div class="large-4 medium-4 small-12 columns">
      <label>First Name
  ...
  <div class="row"><!--Beginning of Third Row-->
    ...
    <div class="large-6 medium-6 small-12 columns">
      <label>Secret Username
        <input id="uname" type="text" name="uname" size="40" maxlength="40" placeholder="Secret Name" value="<?php if (isset($_POST['uname'])) echo $_POST['uname']; ?>"/>
      </label>
    </div>
    <!--The pulldown menu-->
    <div class="large-6 medium-6 small-12 columns">
      ...
      <select name="class" id="#">
        ...
        <option value="30"<?php if (isset($_POST['class']) AND ($_POST['class'] == '30')) echo ' selected="selected"'; ?>>Standard 1 year 30</option>
        <option value="125"<?php if (isset($_POST['class']) AND ($_POST['class'] == '125')) echo ' selected="selected"'; ?>>Standard 5 years 125</option>
        <option value="5"<?php if (isset($_POST['class']) AND ($_POST['class'] == '5')) echo ' selected="selected"'; ?>>Armed Forces 1 year 5</option>
        <option value="2"<?php if (isset($_POST['class']) AND ($_POST['class'] == '2')) echo ' selected="selected"'; ?>>Under 22 1 year 2**</option>
        <option value="15"<?php if (isset($_POST['class']) AND ($_POST['class'] == '15')) echo ' selected="selected"'; ?>>Minimum 1 year 15</option>
      </select>
    </div>

      <div class="large-6 medium-6 small-12 columns">
        <label>First Address
          <input id="addr1" type="text" name="addr1" size="30" maxlength="30" placeholder="First Address" value="<?php if (isset($_POST['addr1'])) echo $_POST['addr1']; ?>"/>
        </label>
      </div>
      <div class="large-6 medium-6 small-12 columns">
        <label> Second Address
          <input id="addr2" type="text" name="addr2" size="30" maxlength="30" placeholder="Second Address" value="<?php if (isset($_POST['addr2'])) echo $_POST['addr2']; ?>"/>
        </label>
      </div>

      <div class="large-6 medium-6 small-12 columns">
        <label>City
          <input id="city" type="text" name="city" size="30" maxlength="30" placeholder="City" value="<?php if (isset($_POST['city'])) echo $_POST['city']; ?>"/>
        </label>
      </div>

      <div class="large-6 medium-6 small-12 columns">
        <label>County
          <input id="county" type="text" name="county" size="30" maxlength="30" placeholder="County" value="<?php if (isset($_POST['county'])) echo $_POST['county']; ?>"/>
        </label>
      </div>

      <div class="large-6 medium-6 small-12 columns">
        <label>Post Code
          <input id="pcode" type="text" name="pcode" size="30" maxlength="30" placeholder="Post Code" value="<?php if (isset($_POST['pcode'])) echo $_POST['pcode']; ?>"/>
        </label>
      </div>

      <div class="large-6 medium-6 small-12 columns">
        <label>Telephone
          <input id="phone" type="text" name="phone" size="30" maxlength="30" placeholder="Telephone" value="<?php if (isset($_POST['phone'])) echo $_POST['phone']; ?>"/>
        </label>
      </div>
