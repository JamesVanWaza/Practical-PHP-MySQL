...
// Make the query
$q = "SELECT ref_num, loctn, thumb, price, mini_descr, b_rooms, status FROM estatedb
...
// Error message
echo '<p class="alert-box alert round">The record could not be retrieved. We apologize
...
if ($current_page != 1) {
echo '<a href="admin-view-houses.php?s=' . ($start - $pagerows) . '&p=' . $pages . '">Previous</a> ';
}
//Create a Next link
